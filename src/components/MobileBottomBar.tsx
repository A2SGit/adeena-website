  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-surface-container/95 backdrop-blur-xl border-t border-white/5">
      <div className="flex items-center justify-around py-2 px-2">
        ...
        >
          <span className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/20 -mt-5">
          ...
          <span className="text-[9px] uppercase tracking-wider font-medium text-[#25D366]">
            WhatsApp
          </span>
        </a>
